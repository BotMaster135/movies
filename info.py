...
USERNAME = environ.get('USERNAME', "https://t.me/botmaster135") # ADMIN USERNAME
...
DATABASE_NAME = environ.get('DATABASE_NAME', "SourabhProfessor")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002040575112')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002236210203'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002040575112')
